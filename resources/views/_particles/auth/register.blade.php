    ...
    <div class="login-container steps">
        ...
        <div class="signin-form email-form">
            ...
            <div class="usernamebox">
                <input id="username" class="cd-input" name="username" placeholder="{{ trans('index.username') }}"
                    type="text" value="{{ Session::get('username') !== null  ? Session::get('username') : "" }}">
            </div>
            <div class="emailbox">
                <input id="email" name="email" class="cd-input" placeholder="{{ trans('index.email') }}" type="email"
                    value="">
            </div>
            <div class="passwordbox">
                <input id="password" name="password" class="cd-input" placeholder="{{ trans('index.password') }}"
                    type="password">
            </div>
            ...
            @endif
            <button type="button" class="button button-orange button-full" style="margin-top:5px"
