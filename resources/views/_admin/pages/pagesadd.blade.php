...
<section class="content">
    {!! Form::open(array('action' => 'Admin\PagesController@addnew', 'method' => 'POST', 'enctype' =>
    'multipart/form-data')) !!}
    <div class="row">
        <div class="col-md-6">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="text" class="textarea" id="textarea"
                            placeholder="{{ trans('admin.Placesometexthere') }}"
                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ isset($page->text) ? $page->text : null }}</textarea>
                    </div>
                    <hr>
                    <div class="form-group" style="display: none">
                        <label>Footer Link?</label>
                        {!! Form::select('footer', ['1' => trans('admin.yes'),'0' => trans('admin.no')],
                        isset($page->footer) ? $page->footer : null, ['class' => 'form-control']) !!}
                    </div>
