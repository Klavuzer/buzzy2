    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="/admin/all?only=unapprove" class="small-box-footer">{{ trans('admin.moreinfo') }} <i
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="/admin/all" class="small-box-footer">{{ trans('admin.moreinfo') }} <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="/admin/users" class="small-box-footer">{{ trans('admin.moreinfo') }} <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><!-- ./col -->
        <div class="col-lg-3 col-xs-6">
