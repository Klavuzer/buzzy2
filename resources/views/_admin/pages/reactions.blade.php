        ...
        <div class="col-md-7">
            <div class="row">
                ...
                <div class="col-md-4 col-sm-3 col-xs-12">
                    <div class="info-box">
                        <span class="info-box-icon bg-aqua"> <img alt="{{ $react->name }}" src="{{ $react->icon }} "
                                width="50"></span>
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-text">
                                <a href="reactions?edit={{ $react->id }}" data-toggle="tooltip"
                                    data-original-title="{{ trans('admin.Edit') }}" class="btn btn-box-tool btn-info"
                                    style="  margin-top:4px;  padding: 2px 5px;color:#fff"><i
                                        class="fa fa-edit"></i></a>
                                <a href="{{ url('admin/reactions/delete/'.$react->id) }}" data-toggle="tooltip"
        ...
        <div class="col-md-5">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        {{ isset($reaction->id) ? 'Edit Reaction:'.$reaction->name : 'Add Reaction Icon' }}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
