...
<div class="box box-info">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <p>{{ \Str::limit($item->comment, 150) }}</p>
                            ...
                            @if($item->post)
                            <a href="{{ generate_comment_url($item) }}" target="_blank" style="margin-left:7px;">
                            <i class="fa fa-file-text" style="font-size:11px"></i>
    ...
    <div class="box-footer text-center">
        <a href="{{action('Admin\CommentController@index', ['only' => 'unapprove'])}}" class="uppercase">{{ trans('admin.viewall') }}</a>
    </div><!-- /.box-footer -->
</div>
