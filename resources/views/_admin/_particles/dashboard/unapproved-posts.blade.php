<div class="box box-info">
            ...
            <table class="table no-margin" style="overflow: auto;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a target="_blank" href="{{ generate_post_url($item) }}">{{ $item->title }}</a>
                        </td>
                        <td>
                            @if($item->type == 'news')
    ...
    <div class="box-footer text-center">
        <a href="{{action('Admin\PostsController@index', ['only' => 'unapprove'])}}" class="uppercase">{{ trans('admin.viewall') }}</a>
    </div><!-- /.box-footer -->
</div>
