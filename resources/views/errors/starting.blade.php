    ...
    <div class="global-container container starting" style="text-align:center">
        ...
        <div class="modeempty-header green">
            <div class="modeempty_text">
                ...
                <P> You must have at least 1 posts.</P>
                <BR><BR>
                <b style="margin-top:10px">Go to Admin Panel Settings and Configure the Site!</b>
                <br>
                <a href="/admin/config" style="margin-top:10px" class="button button-big button-orange">Admin Panel
                    Settings</a>
                ...
                <p>
                    ...
                    <div class="loginat">
                        ...
                        Password: <u>admin</u>
                        <br>
                        <small>You can find login form at top-right on this page or <a href="/login"
                                style="margin-top:50px" class="">Click to Login</a></small>
