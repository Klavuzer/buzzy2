    ...
    <div class="global-container container">
        <div class="headline-cats-wrap">
            ...
            <div class="cat-list">
                ...
                @foreach($subs as $cat)
                <a class="cat_link" data-type="{{ $cat->name_slug }}" href="/{{ $cat->name_slug }}">
                    {{ $cat->name }}</a>
                @endforeach
                @endif
            </div>
    ...
    <div class="content">
        <div class="content-timeline" style="float: left;width: 100%;">
            ...
            <div class="timeline-title"><span
                    style="color:#d92b2b">{{ trans('index.'.$category->name_slug) == 'index.'.$category->name_slug ? $category->name :  trans('index.'.$category->name_slug) }}
                </span>
                <a target=_blank style="float:right;  background: #f4851f;width:24px;height:24px;margin:2px 0 0 0"
                    href="{{ $category->name_slug }}.xml"><i style="color:#fff" class="material-icons">&#xE0E5;</i></a>
                <style>
