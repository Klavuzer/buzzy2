...
class UserMessageController extends UserBaseController
{
    ...
    public function index()
    {
        ...
        return view('pages.user.messages.index', compact('threads'));
    }
    ...
    public function show($user_slug, $id)
    {
        ...
        return view('pages.user.messages.show', compact('thread', 'messages'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('pages.user.messages.create', compact('users', 'to_user'));
    }
