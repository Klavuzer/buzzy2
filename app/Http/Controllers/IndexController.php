...
class IndexController extends Controller
{
    public function index()
    {
        ...
        // Featured Posts
        $lastFeaturestop = Post::with('user')->forHome('Features')->byActiveTypes()->byPublished()->byLanguage()->byApproved()->byFeatured()->take(get_headline_posts_count())->get();
        ...
        // Trending Posts
        $lastTrending    = Post::with('popularityStats')->forHome()->byActiveTypes()->getStats('one_day_stats', 'DESC', 10)->byPublished()->byLanguage()->byApproved()->getCached('home_trending', now()->addMinutes(5));
